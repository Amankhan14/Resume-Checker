...
Original file is located at
    https://colab.research.google.com/drive/1FT6gRhuryJnQdMJTioN6SERiY_3HnOAI
"""
...
demo=gr.Interface(
    ...
    inputs=[
        ...
        gr.Textbox(label="📝Paste Job Discription",placeholder="paste JD here....",lines=8)
        ],
    outputs=[
        gr.Image(type="filepath", label="🎯 ATS Score"),
        gr.Markdown(label="💡 Suggestions & Best Fit Role")
    ],
    title="🚀 Resume Analyzer based on Job Description",
    description="Upload your resume and paste the job description to get ATS match score and recommendations!",
    theme="default"
)
